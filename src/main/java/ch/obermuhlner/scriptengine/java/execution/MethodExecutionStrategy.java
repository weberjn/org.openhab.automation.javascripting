...
public class MethodExecutionStrategy implements ExecutionStrategy {
     ...
     */
    public static MethodExecutionStrategy byArgumentTypes(Class<?> clazz, String methodName, Class<?>[] argumentTypes,
            Object... arguments) throws ScriptException {
        try {
     ...
     * @throws ScriptException if no matching public method was found
     */
    public static MethodExecutionStrategy byMatchingArguments(Class<?> clazz, String methodName, Object... arguments)
